...
def UnEmp(NATIVITY = None, PATH = '/', RAC1P=None, HISP=None,GRP11=None):
    ...
    print '----------------- For Total Geo'
    l = create_row_dataframe(NATIVITY=NATIVITY,ESR=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
    l.insert(0, "Total Geo")
    full_list.append(l)
    # For all the PUMA counties.
    for p in global_data.PUMA_Counties:
        print '----------------- For PUMA: ', puma_county(p)
        l = create_row_dataframe(PUMA=p,NATIVITY=NATIVITY,ESR=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
...
def FT_Work(NATIVITY = None,PATH = '/', RAC1P=None, HISP=None,GRP11=None):
    region_1_list,region_2_list,region_3_list,region_4_list,region_5_list = [],[],[],[],[]
    region_6_list,region_7_list,region_8_list,region_9_list,region_10_list = [],[],[],[],[]
    ...
    # First row is not a PUMA county. It is the summation row.
    print '----------------- For Total Geo'
    l = create_row_dataframe(NATIVITY=NATIVITY,WKHP=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
    l.insert(0, "Total Geo")
    full_list.append(l)
    # For all the PUMA counties.
    for p in global_data.PUMA_Counties:
        print '----------------- For PUMA: ', puma_county(p)
        l = create_row_dataframe(PUMA=p,NATIVITY=NATIVITY,WKHP=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
        l.insert(0,puma_county(p))
        full_list.append(l)
        # add list to appropriate region list
        if p in region_1:
...
def Poverty(NATIVITY = None,PATH = '/', RAC1P=None, HISP=None,GRP11=None):
    region_1_list,region_2_list,region_3_list,region_4_list,region_5_list = [],[],[],[],[]
    region_6_list,region_7_list,region_8_list,region_9_list,region_10_list = [],[],[],[],[]
    ...
    # First row is not a PUMA county. It is the summation row.
    print '----------------- For Total Geo'
    l = create_row_dataframe(NATIVITY=NATIVITY,POVPIP=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
    l.insert(0, "Total Geo")
    full_list.append(l)
    # For all the PUMA counties.
    for p in global_data.PUMA_Counties:
        print '----------------- For PUMA: ', puma_county(p)
        l = create_row_dataframe(PUMA=p,NATIVITY=NATIVITY,POVPIP=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
        l.insert(0,puma_county(p))
        full_list.append(l)
        # add list to appropriate region list
        if p in region_1:
...
def Working_poor(NATIVITY = None,PATH = '/', RAC1P=None, HISP=None,GRP11=None):
    region_1_list,region_2_list,region_3_list,region_4_list,region_5_list = [],[],[],[],[]
    region_6_list,region_7_list,region_8_list,region_9_list,region_10_list = [],[],[],[],[]
    # P: Poverty, NP: Not Poverty
    ...
    # First row is not a PUMA county. It is the summation row.
    print '----------------- For Total Geo'
    l = create_row_dataframe(WKHP=1,NATIVITY=NATIVITY,POVPIP=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
    l.insert(0, "Total Geo")
    full_list.append(l)
    # For all the PUMA counties.
    for p in global_data.PUMA_Counties:
...
def Rent_burden(NATIVITY = None,PATH = '/', RAC1P=None, HISP=None,GRP11=None):
    region_1_list,region_2_list,region_3_list,region_4_list,region_5_list = [],[],[],[],[]
    region_6_list,region_7_list,region_8_list,region_9_list,region_10_list = [],[],[],[],[]
    # P: Poverty, NP: Not Poverty
    ...
    # First row is not a PUMA county. It is the summation row.
    print '----------------- For Total Geo'
    l = create_row_dataframe(NATIVITY=NATIVITY,GRPIP=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
    l.insert(0, "Total Geo")
    full_list.append(l)
    # For all the PUMA counties.
    for p in global_data.PUMA_Counties:
        print '----------------- For PUMA: ', puma_county(p)
        l = create_row_dataframe(PUMA=p,NATIVITY=NATIVITY,GRPIP=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
        l.insert(0,puma_county(p))
        full_list.append(l)
        # add list to appropriate region list
        if p in region_1:
...
def Home_ownership(NATIVITY = None,PATH = '/', RAC1P=None, HISP=None,GRP11=None):
    region_1_list,region_2_list,region_3_list,region_4_list,region_5_list = [],[],[],[],[]
    region_6_list,region_7_list,region_8_list,region_9_list,region_10_list = [],[],[],[],[]
    # P: Poverty, NP: Not Poverty
    ...
    # First row is not a PUMA county. It is the summation row.
    print '----------------- For Total Geo'
    l = create_row_dataframe(NATIVITY=NATIVITY,TEN=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
    l.insert(0, "Total Geo")
    full_list.append(l)
    # For all the PUMA counties.
    for p in global_data.PUMA_Counties:
        print '----------------- For PUMA: ', puma_county(p)
        l = create_row_dataframe(PUMA=p,NATIVITY=NATIVITY,TEN=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
        l.insert(0,puma_county(p))
        full_list.append(l)
        # add list to appropriate region list
        if p in region_1:
...
def Income_level_FT_Workers(NATIVITY = None,PATH = '/', RAC1P=None, HISP=None,GRP11=None):
    region_1_list,region_2_list,region_3_list,region_4_list,region_5_list = [],[],[],[],[]
    region_6_list,region_7_list,region_8_list,region_9_list,region_10_list = [],[],[],[],[]
    ...
    # First row is not a PUMA county. It is the summation row.
    print '----------------- For Total Geo'
    l = create_row_dataframe(NATIVITY=NATIVITY,WKHP=1,PINCP=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
    l.insert(0, "Total Geo")
    full_list.append(l)
    # For all the PUMA counties.
    for p in global_data.PUMA_Counties:
        print '----------------- For PUMA: ', puma_county(p)
        l = create_row_dataframe(PUMA=p,NATIVITY=NATIVITY,WKHP=1,PINCP=1,RAC1P=RAC1P,HISP=HISP,GRP11=GRP11)
        l.insert(0,puma_county(p))
        full_list.append(l)
        # add list to appropriate region list
        if p in region_1:
            region_1_list.append(l[1:])
            sum_region_1 = [sum(x) for x in zip(*region_1_list)]
            if sum_region_1[3] == "#DIV/0!":
                sum_region_1[3] = 0
            else:
                sum_region_1[3] = sum_region_1[3] / len(region_1)
            if sum_region_1[9] == "#DIV/0!":
                sum_region_1[9] = 0
            else:
                sum_region_1[9] = sum_region_1[9] / len(region_1)
            if sum_region_1[15] == "#DIV/0!":
                sum_region_1[15] = 0
            else:
                sum_region_1[15] = sum_region_1[15] / len(region_1)
            if sum_region_1[21] == "#DIV/0!":
                sum_region_1[21] = 0
            else:
                sum_region_1[21] = sum_region_1[21] / len(region_1)
        if p in region_2:
            region_2_list.append(l[1:])
            sum_region_2 = [sum(x) for x in zip(*region_2_list)]
            if sum_region_2[3] == "#DIV/0!":
                sum_region_2[3] = 0
            else:
                sum_region_2[3] = sum_region_2[3] / len(region_2)
            if sum_region_2[9] == "#DIV/0!":
                sum_region_2[9] = 0
            else:
                sum_region_2[9] = sum_region_2[9] / len(region_2)
            if sum_region_2[15] == "#DIV/0!":
                sum_region_2[15] = 0
            else:
                sum_region_2[15] = sum_region_2[15] / len(region_2)
            if sum_region_2[21] == "#DIV/0!":
                sum_region_2[21] = 0
            else:
                sum_region_2[21] = sum_region_2[21] / len(region_2)
        if p in region_3:
            region_3_list.append(l[1:])
            sum_region_3 = [sum(x) for x in zip(*region_3_list)]
            if sum_region_3[3] == "#DIV/0!":
                sum_region_3[3] = 0
            else:
                sum_region_3[3] = sum_region_3[3] / len(region_3)
            if sum_region_3[9] == "#DIV/0!":
                sum_region_3[9] = 0
            else:
                sum_region_3[9] = sum_region_3[9] / len(region_3)
            if sum_region_3[15] == "#DIV/0!":
                sum_region_3[15] = 0
            else:
                sum_region_3[15] = sum_region_3[15] / len(region_3)
            if sum_region_3[21] == "#DIV/0!":
                sum_region_3[21] = 0
            else:
                sum_region_3[21] = sum_region_3[21] / len(region_3)
        if p in region_4:
            region_4_list.append(l[1:])
            sum_region_4 = [sum(x) for x in zip(*region_4_list)]
            if sum_region_4[3] == "#DIV/0!":
                sum_region_4[3] = 0
            else:
                sum_region_4[3] = sum_region_4[3] / len(region_4)
            if sum_region_4[9] == "#DIV/0!":
                sum_region_4[9] = 0
            else:
                sum_region_4[9] = sum_region_4[9] / len(region_4)
            if sum_region_4[15] == "#DIV/0!":
                sum_region_4[15] = 0
            else:
                sum_region_4[15] = sum_region_4[15] / len(region_4)
            if sum_region_4[21] == "#DIV/0!":
                sum_region_4[21] = 0
            else:
                sum_region_4[21] = sum_region_4[21] / len(region_4)
        if p in region_5:
            region_5_list.append(l[1:])
            sum_region_5 = [sum(x) for x in zip(*region_5_list)]
            if sum_region_5[3] == "#DIV/0!":
                sum_region_5[3] = 0
            else:
                sum_region_5[3] = sum_region_5[3] / len(region_5)
            if sum_region_5[9] == "#DIV/0!":
                sum_region_5[9] = 0
            else:
                sum_region_5[9] = sum_region_5[9] / len(region_5)
            if sum_region_5[15] == "#DIV/0!":
                sum_region_5[15] = 0
            else:
                sum_region_5[15] = sum_region_5[15] / len(region_5)
            if sum_region_5[21] == "#DIV/0!":
                sum_region_5[21] = 0
            else:
                sum_region_5[21] = sum_region_5[21] / len(region_5)
        if p in region_6:
            region_6_list.append(l[1:])
            sum_region_6 = [sum(x) for x in zip(*region_6_list)]
            if sum_region_6[3] == "#DIV/0!":
                sum_region_6[3] = 0
            else:
                sum_region_6[3] = sum_region_6[3] / len(region_6)
            if sum_region_6[9] == "#DIV/0!":
                sum_region_6[9] = 0
            else:
                sum_region_6[9] = sum_region_6[9] / len(region_6)
            if sum_region_6[15] == "#DIV/0!":
                sum_region_6[15] = 0
            else:
                sum_region_6[15] = sum_region_6[15] / len(region_6)
            if sum_region_6[21] == "#DIV/0!":
                sum_region_6[21] = 0
            else:
                sum_region_6[21] = sum_region_6[21] / len(region_6)
        if p in region_7:
            region_7_list.append(l[1:])
            sum_region_7 = [sum(x) for x in zip(*region_7_list)]
            if sum_region_7[3] == "#DIV/0!":
                sum_region_7[3] = 0
            else:
                sum_region_7[3] = sum_region_7[3] / len(region_7)
            if sum_region_7[9] == "#DIV/0!":
                sum_region_7[9] = 0
            else:
                sum_region_7[9] = sum_region_7[9] / len(region_7)
            if sum_region_7[15] == "#DIV/0!":
                sum_region_7[15] = 0
            else:
                sum_region_7[15] = sum_region_7[15] / len(region_7)
            if sum_region_7[21] == "#DIV/0!":
                sum_region_7[21] = 0
            else:
                sum_region_7[21] = sum_region_7[21] / len(region_7)
        if p in region_8:
            region_8_list.append(l[1:])
            sum_region_8 = [sum(x) for x in zip(*region_8_list)]
            if sum_region_8[3] == "#DIV/0!":
                sum_region_8[3] = 0
            else:
                sum_region_8[3] = sum_region_8[3] / len(region_8)
            if sum_region_8[9] == "#DIV/0!":
                sum_region_8[9] = 0
            else:
                sum_region_8[9] = sum_region_8[9] / len(region_8)
            if sum_region_8[15] == "#DIV/0!":
                sum_region_8[15] = 0
            else:
                sum_region_8[15] = sum_region_8[15] / len(region_8)
            if sum_region_8[21] == "#DIV/0!":
                sum_region_8[21] = 0
            else:
                sum_region_8[21] = sum_region_8[21] / len(region_8)
        if p in region_9:
            region_9_list.append(l[1:])
            sum_region_9 = [sum(x) for x in zip(*region_9_list)]
            if sum_region_9[3] == "#DIV/0!":
                sum_region_9[3] = 0
            else:
                sum_region_9[3] = sum_region_9[3] / len(region_9)
            if sum_region_9[9] == "#DIV/0!":
                sum_region_9[9] = 0
            else:
                sum_region_9[9] = sum_region_9[9] / len(region_9)
            if sum_region_9[15] == "#DIV/0!":
                sum_region_9[15] = 0
            else:
                sum_region_9[15] = sum_region_9[15] / len(region_9)
            if sum_region_9[21] == "#DIV/0!":
                sum_region_9[21] = 0
            else:
                sum_region_9[21] = sum_region_9[21] / len(region_9)
        if p in region_10:
            region_10_list.append(l[1:])
            sum_region_10 = [sum(x) for x in zip(*region_10_list)]
            if sum_region_10[3] == "#DIV/0!":
                sum_region_10[3] = 0
            else:
                sum_region_10[3] = sum_region_10[3] / len(region_10)
            if sum_region_10[9] == "#DIV/0!":
                sum_region_10[9] = 0
            else:
                sum_region_10[9] = sum_region_10[9] / len(region_10)
            if sum_region_10[15] == "#DIV/0!":
                sum_region_10[15] = 0
            else:
                sum_region_10[15] = sum_region_10[15] / len(region_10)
            if sum_region_10[21] == "#DIV/0!":
                sum_region_10[21] = 0
            else:
                sum_region_10[21] = sum_region_10[21] / len(region_10)
...
def get_disparity_score_grade_grp_11(PATH=None):
    ...
    UnEmp=pandas.read_csv('data/2017/GRP11/step_2/UnEmp.csv',usecols=['puma','HSINC_UnEmp_Total'])
    FT_work=pandas.read_csv('data/2017/GRP11/step_2/FT_Work.csv',usecols=['HSINC_FT_Work_Total'])
    Poverty=pandas.read_csv('data/2017/GRP11/step_2/Poverty.csv',usecols=['HSINC_Poverty_Total'])
    Working_Poor=pandas.read_csv('data/2017/GRP11/step_2/Working_Poor.csv',usecols=['HSINC_Working_Poor_Total'])
    Rent_Burden=pandas.read_csv('data/2017/GRP11/step_2/Rent_Burden.csv',usecols=['HSINC_Rent_Burden_Total'])
    Home_ownership=pandas.read_csv('data/2017/GRP11/step_2/Home_Ownership.csv',usecols=['HSINC_Home_Ownership_Total'])
    Income_level=pandas.read_csv('data/2017/GRP11/step_2/Income_level_FT_Workers.csv',usecols=['HSINC_Avg_PINCP_mf_t'])
...
def get_NB_All_FB_All_disparity():
    get_disparity('data/2017/Disparities/','NB_ALL_FB_ALL')

def get_NB_ALL_F_FB_ALL_F_disparity():
    get_disparity('data/2017/Disparities/', 'NB_ALL_F_FB_ALL_F')

def get_FB_ALL_F_M_disparity():
    get_disparity('data/2017/Disparities/', 'FB_ALL_F_M')

def get_NB_WNH_FB_POC_disparity():
    get_disparity('data/2017/Disparities/', 'NB_WNH_FB_POC')

def get_NB_WNH_FB_POC_F_disparity():
    get_disparity('data/2017/Disparities/', 'NB_WNH_FB_POC_F')

def get_score_grade_all(PATH=None):
    sg_data_NB_ALL_FB_ALL_final = pandas.DataFrame()
    sg_data_NB_ALL_FB_ALL = pandas.read_csv(
        'data/2017/Disparities/NB_ALL_FB_ALL_Disparity.csv').replace([np.inf, -np.inf],
                                                                                          np.nan)
...
def get_score_grade_f(PATH=None):
    ...
    sg_data_f = pandas.read_csv(
        'data/2017/Disparities/NB_ALL_F_FB_ALL_F_Disparity.csv').replace([np.inf, -np.inf],
                                                                                          np.nan)
...
def get_score_grade_FB_ALL_F_M(PATH=None):
    ...
    sg_data_f_m = pandas.read_csv(
        'data/2017/Disparities/FB_ALL_F_M_Disparity.csv').replace([np.inf, -np.inf],
                                                                                          np.nan)
...
def get_score_grade_NB_WNH_FB_POC(PATH=None):
    ...
    sg_data_NB_WNH_FB_POC = pandas.read_csv(
        'data/2017/Disparities/NB_WNH_FB_POC_Disparity.csv').replace([np.inf, -np.inf],
                                                                                          np.nan)
...
def get_score_grade_NB_WNH_FB_POC_F(PATH=None):
    ...
    sg_data_NB_WNH_FB_POC_F = pandas.read_csv(
        'data/2017/Disparities/NB_WNH_FB_POC_F_Disparity.csv').replace([np.inf, -np.inf],
                                                                                          np.nan)
...
def run():
    ...
    get_disparity_score_grade_grp_11('data/2017/GRP11/Scores_Grades/')
    get_score_grade_all('data/2017/Scores_Grades/')
    get_score_grade_f('data/2017/Scores_Grades/')
    get_score_grade_FB_ALL_F_M('data/2017/Scores_Grades/')
    get_score_grade_NB_WNH_FB_POC('data/2017/Scores_Grades/')
    get_score_grade_NB_WNH_FB_POC_F('data/2017/Scores_Grades/')
    cj.csv_to_json()
