...
def ENG_Proficient(NATIVITY = None, PATH = '/', RAC1P=None, HISP=None,GRP11=None,name=None):
    ...
    for p in global_data_eng.PUMA_Counties:
    ...
    if NATIVITY is 1 and RAC1P is None and HISP is None:
        global_data_eng.NB_ALL_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_eng.NB_ALL_p.to_csv(PATH + 'step_2/' + 'NB_ALL_eng_prof_percent.csv', na_rep="#DIV/0!")
    if NATIVITY is 1 and RAC1P is 1 and HISP is 1:
        global_data_eng.NB_WNH_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_eng.NB_WNH_p.to_csv(PATH + 'step_2/' + 'NB_WNH_eng_prof_percent.csv', na_rep="#DIV/0!")
    if NATIVITY is 2 and RAC1P is None and HISP is None:
        global_data_eng.FB_ALL_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_eng.FB_ALL_p.to_csv(PATH + 'step_2/' + 'FB_ALL_eng_prof_percent.csv', na_rep="#DIV/0!")
    if NATIVITY is 2 and RAC1P is 1 and HISP is 1:
        global_data_eng.FB_POC_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_eng.FB_POC_p.to_csv(PATH + 'step_2/' + 'FB_POC_eng_prof_percent.csv', na_rep="#DIV/0!")


def FB_ALL():
    print 'FB_ALL'
    PATH = 'data/2017/FB_All/'
    ENG_Proficient(NATIVITY=2,PATH=PATH,name='FB_eng_prof.csv')

def FB_POC():
    print 'FB_POC'
    PATH = 'data/2017/FB_POC/'
    ENG_Proficient(NATIVITY=2,PATH=PATH,RAC1P=1,HISP=1,name='FB_POC_eng_prof.csv')
