...
def Edu_Attainment(NATIVITY = None, PATH = '/', RAC1P=None, HISP=None,POBP=None,POBP72=None,name=None):
    ...
    if NATIVITY is 1 and POBP is None and RAC1P is None and HISP is None:
        ...
        global_data_edu_PR_HISP.NB_ALL_p.to_csv(PATH + 'step_2/' + 'NB_ALL_Edu_percent.csv', na_rep="#DIV/0!")
    if NATIVITY is 2 and HISP is 1 and RAC1P is None:
        global_data_edu_PR_HISP.FB_Hispanic_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.FB_Hispanic_p.to_csv(PATH + 'step_2/' + 'FB_Hispanic_Edu_percent.csv', na_rep="#DIV/0!")
    if NATIVITY is 2 and RAC1P is 1 and HISP is 1:
        global_data_edu_PR_HISP.FB_WNH_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.FB_WNH_p.to_csv(PATH + 'step_2/' + 'FB_WNH_Edu_percent.csv', na_rep="#DIV/0!")
    if NATIVITY is 1 and HISP is 1 and POBP72 is 1 and RAC1P is None:
        ...
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.PR_Hispanic_p.to_csv(PATH + 'step_2/' + 'PR_Hispanic_Edu_percent.csv', na_rep="#DIV/0!")
    if NATIVITY is 1 and POBP is 1 and HISP is None and RAC1P is None:
        ...
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.NB_Mainland_p.to_csv(PATH + 'step_2/' + 'NB_Mainland_Edu_percent.csv', na_rep="#DIV/0!")
    if NATIVITY is 1 and POBP is 1 and HISP is 1 and RAC1P is None:
        ...
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.NB_Mainland_PR_p.to_csv(PATH + 'step_2/' + 'NB_Mainland_PR_Edu_percent.csv', na_rep="#DIV/0!")
    if NATIVITY is 2 and HISP is 1 and RAC1P is 2:
        global_data_edu_PR_HISP.FB_Hispanic_POC_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.FB_Hispanic_POC_p.to_csv(PATH + 'step_2/' + 'FB_Hispanic_POC_Edu_percent.csv', na_rep="#DIV/0!")
    # Filter for NB_WNH
    if NATIVITY is 1 and HISP is 1 and RAC1P is 1:
        global_data_edu_PR_HISP.NB_WNH_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.NB_WNH_p.to_csv(PATH + 'step_2/' + 'NB_WNH_Edu_percent.csv', na_rep="#DIV/0!")
    # Filter for NB_Hispanic
    if NATIVITY is 1 and HISP is 1 and RAC1P is None and POBP is None and POBP72 is None:
        global_data_edu_PR_HISP.NB_Hispanic_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.NB_Hispanic_p.to_csv(PATH + 'step_2/' + 'NB_Hispanic_Edu_percent.csv', na_rep="#DIV/0!")
    # Filter for FB_White Hispanic
    if NATIVITY is 2 and HISP is 2 and RAC1P is 3:
        global_data_edu_PR_HISP.FB_White_Hispanic_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.FB_White_Hispanic_p.to_csv(PATH + 'step_2/' + 'FB_White_Hispanic_Edu_percent.csv', na_rep="#DIV/0!")
    # Filter out for PR_POC in PR
    if NATIVITY is 1 and HISP is 1 and RAC1P is 4 and POBP72 is 1:
        global_data_edu_PR_HISP.PR_POC_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.PR_POC_p.to_csv(PATH + 'step_2/' + 'PR_POC_Edu_percent.csv', na_rep="#DIV/0!")
    #Filter out for PR_White in PR
    if NATIVITY is 1 and HISP is 3 and RAC1P is 5 and POBP72 is 1:
        global_data_edu_PR_HISP.PR_White_p = get_percentage(df=result_df)
        make_sure_path_exists(PATH + 'step_2/')
        global_data_edu_PR_HISP.PR_White_p.to_csv(PATH + 'step_2/' + 'PR_White_Edu_percent.csv', na_rep="#DIV/0!")


def NB_ALL():
    print ('NB_ALL')
    PATH = 'data_PR_HISP/2016/NB_All/'
    Edu_Attainment(NATIVITY=1, PATH=PATH,name='NB_ALL_Edu.csv')

def FB_Hispanic():
    print('FB_Hispanic')
    PATH = 'data_PR_HISP/2016/FB_Hispanic/'

    Edu_Attainment(NATIVITY=2, HISP=1, RAC1P=None, PATH=PATH,name='FB_Hispanic_Edu.csv')
...
def FB_WNH():
    ...
    Edu_Attainment(NATIVITY=2, HISP=1, RAC1P=1, PATH=PATH,name='FB_WNH_Edu.csv')
...
def FB_Hispanic_POC():
    ...
    Edu_Attainment(NATIVITY=2, HISP=1, RAC1P=2, PATH=PATH,name='FB_Hispanic_POC_Edu.csv')
...
def PR_Hispanic():
    ...
    Edu_Attainment(NATIVITY=1, HISP=1,POBP72=1, RAC1P=None, PATH=PATH,name='PR_Hispanic_Edu.csv')
...
def NB_Mainland():
    ...
    Edu_Attainment(NATIVITY=1, POBP=1, PATH=PATH,name='NB_Mainland_Edu.csv')
...
def NB_Mainland_PR():
    ...
    Edu_Attainment(NATIVITY=1, POBP=1, HISP=1, PATH=PATH,name='NB_Mainland_PR_Edu.csv')
...
def NB_WNH():
    ...
    Edu_Attainment(NATIVITY=1, HISP=1, RAC1P=1, PATH=PATH,name='NB_WNH_Edu.csv')
...
def NB_Hispanic():
    ...
    Edu_Attainment(NATIVITY=1, HISP=1, RAC1P=None, POBP72=None, POBP=None, PATH=PATH,name='NB_Hispanic_Edu.csv')
...
def FB_White_Hispanic():
    ...
    Edu_Attainment(NATIVITY=2, HISP=2, RAC1P=3, PATH=PATH,name='FB_WHite_Hispanic_Edu.csv')

def PR_POC():
    print('PR_People of color')
    PATH = 'data_PR_HISP/2016/PR_POC/'

    Edu_Attainment(NATIVITY=1, HISP=1, RAC1P=4,POBP72=1,PATH=PATH,name='PR_POC_Edu.csv')

def PR_White():
    print('PR_White')
    PATH = 'data_PR_HISP/2016/PR_White/'

    Edu_Attainment(NATIVITY=1, HISP=3, RAC1P=5,POBP72=1,PATH=PATH,name='PR_White_Edu.csv')
...
def get_percentage(df = None):
    ...
    for i in df.index:
        ...
        new_df.at[i, 'BABS_m'] = ((df.at[i,'BABS_m'] * (1.0)) / (df.at[i,'BABS_m'] + df.at[i,'HS_m'] + df.at[i,'HSINC_m']))*100
        new_df.at[i, 'BABS_f'] = ((df.at[i,'BABS_f'] * (1.0)) / (df.at[i,'BABS_f'] + df.at[i,'HS_f'] + df.at[i,'HSINC_f']))*100

        new_df.at[i, 'HS_mf_t'] = ((df.at[i, 'HS_mf_t'] * (1.0)) / df.at[i, 'Total_Population']) * 100
        new_df.at[i, 'HS_m'] = ((df.at[i, 'HS_m'] * (1.0)) / (df.at[i,'BABS_m'] + df.at[i,'HS_m'] + df.at[i,'HSINC_m'])) * 100
        new_df.at[i, 'HS_f'] = ((df.at[i, 'HS_f'] * (1.0)) / (df.at[i,'BABS_f'] + df.at[i,'HS_f'] + df.at[i,'HSINC_f'])) * 100

        new_df.at[i, 'HSINC_mf_t'] = ((df.at[i, 'HSINC_mf_t'] * (1.0)) / df.at[i, 'Total_Population']) * 100
        new_df.at[i, 'HSINC_m'] = ((df.at[i, 'HSINC_m'] * (1.0)) / (df.at[i,'BABS_m'] + df.at[i,'HS_m'] + df.at[i,'HSINC_m'])) * 100
        new_df.at[i, 'HSINC_f'] = ((df.at[i, 'HSINC_f'] * (1.0)) / (df.at[i,'BABS_f'] + df.at[i,'HS_f'] + df.at[i,'HSINC_f'])) * 100
